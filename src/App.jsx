      ...
      <div className={styles.mainBox}>
        ...
        <div className={styles.contentInfo}>
          ...
          <div  className={styles.generalInfo}> 
            ...
            <div style={!location ? {opacity: 0.5} : {opacity: 1}} id={"location"} className={styles.infoWrap}>
            ...
            <div style={!website ? {opacity: 0.5} : {opacity: 1}} className={styles.infoWrapp}>
              ...
              <span>{website ? website : "Not available"}</span>
            </div>

            <div style={!twitter ? {opacity: 0.5} : {opacity: 1}}className={styles.infoWrapp}>
            ...
            <div style={!company ? {opacity: 0.5} : {opacity: 1}} className={styles.infoWrapp}>
              <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                <g fill="#4b6a9b">
